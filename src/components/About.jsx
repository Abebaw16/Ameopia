      ...
      <div className={styles.about}>
        ...
        <section className={styles.aspirations}>
          ...
          <p>
            ...
            I bring problem-solving skills, adaptability, and a strong work
            ethic to any team. For detailed information about my education,
            skills, and experience, please refer to my{" "}
            <Link to="/resume">Resume</Link> section.
          </p>
        </section>
